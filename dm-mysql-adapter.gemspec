...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dm-do-adapter>, ["~> 1.1.0.rc2"])
      s.add_development_dependency(%q<dm-migrations>, ["~> 1.1.0.rc2"])
      s.add_development_dependency(%q<jeweler>, ["~> 1.5.2"])
      s.add_development_dependency(%q<rake>, ["~> 0.8.7"])
      s.add_development_dependency(%q<rspec>, ["~> 1.3.1"])
    else
      s.add_dependency(%q<do_mysql>, ["~> 0.10.2"])
      s.add_dependency(%q<dm-do-adapter>, ["~> 1.1.0.rc2"])
      s.add_dependency(%q<dm-migrations>, ["~> 1.1.0.rc2"])
